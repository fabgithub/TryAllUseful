...
#include "/Volumes/Macintosh-HD/Test.localized/TestAllUseful/tryCStackOperation/testFakeThreadWrap.h"

static testFakeThreadWrap suite_testFakeThreadWrap;

static CxxTest::List Tests_testFakeThreadWrap = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_testFakeThreadWrap( "testFakeThreadWrap.h", 23, "testFakeThreadWrap", suite_testFakeThreadWrap, Tests_testFakeThreadWrap );

static class TestDescription_suite_testFakeThreadWrap_testCommon : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_testFakeThreadWrap_testCommon() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 54, "testCommon" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testYieldWithParam() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 59, "testYieldWithParam" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testResumeWithParam() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 64, "testResumeWithParam" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testReuseFakeThread() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 69, "testReuseFakeThread" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testResumeInFakeThread() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 145, "testResumeInFakeThread" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testMemorySizeForFakeThread() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 167, "testMemorySizeForFakeThread" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testMemorySizeForFakeThread2() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 180, "testMemorySizeForFakeThread2" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testResumeCount() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 234, "testResumeCount" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testResumeCountT() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 275, "testResumeCountT" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testFakeThreadTemplate_Common() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 323, "testFakeThreadTemplate_Common" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testFakeThreadTemplate_Start() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 336, "testFakeThreadTemplate_Start" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testFakeThreadTemplate_Yield() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 340, "testFakeThreadTemplate_Yield" ) {}
...
public:
 TestDescription_suite_testFakeThreadWrap_testFakeThreadTemplate_Resume() : CxxTest::RealTestDescription( Tests_testFakeThreadWrap, suiteDescription_testFakeThreadWrap, 344, "testFakeThreadTemplate_Resume" ) {}
